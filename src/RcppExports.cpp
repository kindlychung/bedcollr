...
RcppExport SEXP bedcollr_rcpparma_hello_world() {
BEGIN_RCPP
    SEXP __sexp_result;
    {
...
RcppExport SEXP bedcollr_rcpparma_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
...
RcppExport SEXP bedcollr_rcpparma_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
